...
namespace Illuminate\Support\Facades {
    ...
    class Lang {
         ...
         *
         * @param \Illuminate\Translation\Translator $translator The translator instance to inject.
         * @return void
         * @static
         */
        public static function setLaravelTranslator($translator)
        {
            /** @var \Ultra\TranslationManager\TranslationManager $instance */
            $instance->setLaravelTranslator($translator);
        }
        ...
        {
            /** @var \Ultra\TranslationManager\TranslationManager $instance */
            return $instance->get($key, $replace, $locale);
        }
         ...
         * @static
         */
        public static function registerPackageTranslations($package, $baseLangPath)
        {
            /** @var \Ultra\TranslationManager\TranslationManager $instance */
...
namespace Ultra\ErrorManager\Facades {
    ...
    class UltraError {
         ...
         *
         * @param \Ultra\ErrorManager\Interfaces\ErrorHandlerInterface $handler
         * @return self
         * @static
         */
        public static function registerHandler($handler)
        {
            /** @var \Ultra\ErrorManager\ErrorManager $instance */
            return $instance->registerHandler($handler);
        }
         ...
         * @static
         */
        public static function defineError($errorCode, $config)
        {
            /** @var \Ultra\ErrorManager\ErrorManager $instance */
            return $instance->defineError($errorCode, $config);
        }
        ...
        {
            /** @var \Ultra\ErrorManager\ErrorManager $instance */
            return $instance->getErrorConfig($errorCode);
        }
         ...
         * @param string $errorCode
         * @param array $context
         * @param \Ultra\ErrorManager\Interfaces\?\Throwable|null $exception
         * @param bool $throw
         * @return \Illuminate\Http\JsonResponse|\Illuminate\Http\RedirectResponse
         * @static
         */
        public static function handle($errorCode, $context = [], $exception = null, $throw = false)
        {
            /** @var \Ultra\ErrorManager\ErrorManager $instance */
            return $instance->handle($errorCode, $context, $exception, $throw);
        }
    ...
    class TestingConditions {
         ...
         * @static
         */
        public static function setTestingEnabled($enabled)
        {
            /** @var \Ultra\ErrorManager\Services\TestingConditionsManager $instance */
            return $instance->setTestingEnabled($enabled);
        }
        ...
        {
            /** @var \Ultra\ErrorManager\Services\TestingConditionsManager $instance */
            return $instance->isTestingEnabled();
        }
         ...
         * @static
         */
        public static function setCondition($condition, $value)
        {
            /** @var \Ultra\ErrorManager\Services\TestingConditionsManager $instance */
            return $instance->setCondition($condition, $value);
        }
         ...
         * @static
         */
        public static function isTesting($condition)
        {
            /** @var \Ultra\ErrorManager\Services\TestingConditionsManager $instance */
            return $instance->isTesting($condition);
        }
         ...
         * @static
         */
        public static function getActiveConditions()
        {
            /** @var \Ultra\ErrorManager\Services\TestingConditionsManager $instance */
            return $instance->getActiveConditions();
        }
         ...
         * @static
         */
        public static function resetAllConditions()
        {
            /** @var \Ultra\ErrorManager\Services\TestingConditionsManager $instance */
            return $instance->resetAllConditions();
        }
         ...
         * @static
         */
        public static function set($condition)
        {
            \Ultra\ErrorManager\Services\TestingConditionsManager::set($condition);
        }
         ...
         * @static
         */
        public static function clear($condition)
        {
            \Ultra\ErrorManager\Services\TestingConditionsManager::clear($condition);
        }
        ...
        {
            \Ultra\ErrorManager\Services\TestingConditionsManager::reset();
        }
...
namespace  {
    ...
    class UltraError extends \Ultra\ErrorManager\Facades\UltraError {}
    class UltraTrans extends \Ultra\TranslationManager\Facades\UltraTrans {}
    class TestingConditions extends \Ultra\ErrorManager\Facades\TestingConditions {}
}
