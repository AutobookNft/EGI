...
<div class="lg:hidden">
        ...
        <div class="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
            ...
            <div class="flex justify-center">
                <div class="flex gap-1 p-1 bg-gray-800 border border-gray-700 rounded-lg">
                    ...
                    {{-- List Mode Button --}}
                    <button class="px-4 py-2 text-sm font-medium transition-all duration-200 rounded mobile-view-toggle"
    ...
    <div id="mobile-content-container">
        ...
        <div id="mobile-list-mode" class="hidden mobile-view-content" data-view="list">
            <x-homepage-egi-list :egis="$egis" :creators="$creators" :collections="$collections"
                :collectors="$collectors" />
        </div>
    </div>
</div>
