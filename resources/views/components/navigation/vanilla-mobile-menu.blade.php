...
<button type="button" data-mobile-menu-trigger
    class="inline-flex items-center justify-center p-2 text-gray-400 transition duration-150 ease-in-out rounded-md hover:bg-gray-100 hover:text-gray-500 focus:outline-none dark:text-gray-500 dark:hover:bg-gray-900 dark:hover:text-gray-400 sm:hidden">
    <svg class="size-6 hamburger-icon" stroke="currentColor" fill="none" viewBox="0 0 24 24">
        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 6h16M4 12h16M4 18h16" />
    </svg>
    <svg class="size-6 close-icon hidden" stroke="currentColor" fill="none" viewBox="0 0 24 24">
        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M6 18L18 6M6 6l12 12" />
    </svg>
</button>

<!-- Mobile Menu Container -->
<div data-mobile-menu class="fixed inset-0 z-50 hidden sm:hidden">
    <!-- Mobile Menu Overlay -->
    <div data-mobile-overlay class="fixed inset-0 bg-black/20 backdrop-blur-sm mobile-menu-overlay"></div>
    
    <!-- Mobile Menu Content -->
    <div class="fixed inset-0 flex">
        <div data-mobile-content class="relative flex flex-col w-full max-w-sm ml-auto bg-white dark:bg-gray-900 shadow-2xl mobile-menu-container transform translate-x-full transition-transform duration-300 ease-out">
