    ...
    @if($creators->count() > 0)
        ...
        <div class="flex space-x-4 overflow-x-auto pb-4 scrollbar-hide" id="creator-carousel-track">
            @foreach($creators as $index => $creator)
                ...
                {{-- Creator Card Item --}}
                <article class="creator-carousel-item flex-shrink-0 w-72 group relative bg-gray-800/50 rounded-xl p-4 border border-gray-700/50 hover:border-gray-600 hover:bg-gray-800/70 transition-all duration-300"
                    ...
                    <div class="text-center mb-4">
                        <a href="{{ route('creator.home', ['id' => $creator->id]) }}"
                           class="block relative mx-auto w-20 h-20 rounded-full overflow-hidden bg-gradient-to-br from-gray-700 to-gray-800 group-hover:ring-2 group-hover:ring-purple-400 transition-all duration-300">
                            ...
                            {{-- Hover overlay --}}
                            <div class="absolute inset-0 bg-purple-400/20 opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex items-center justify-center">
                        ...
                        {{-- Nome Creator --}}
                        <h3 class="mt-3 font-semibold text-white text-sm group-hover:text-purple-300 transition-colors duration-200 line-clamp-2">
                            <a href="{{ route('creator.home', ['id' => $creator->id]) }}">
