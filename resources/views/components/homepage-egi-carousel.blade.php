        ...
        <div class="space-y-12">
            ...
            <div class="carousel-section">
                <div class="flex items-center justify-between mb-6">
                    <div class="flex items-center gap-3">
                        ...
                        <span class="inline-flex items-center px-2 py-1 text-sm font-medium text-purple-300 border rounded-full bg-purple-900/30 border-purple-500/20">
                            {{ $egisCount }}
                        </span>
                    </div>
                    @if(Route::has('egi.index'))
                    <a href="{{ route('egi.index') }}" class="text-sm text-purple-300 hover:text-purple-200 transition-colors">
            ...
            <div class="carousel-section">
                <div class="flex items-center justify-between mb-6">
                    ...
                    <a href="{{ route('creator.index') }}" class="text-sm text-purple-300 hover:text-purple-200 transition-colors">
                        {{ __('egi.carousel.view_all') }} →
                    </a>
                </div>
            ...
            <div class="carousel-section">
                <div class="flex items-center justify-between mb-6">
                    ...
                    <a href="{{ route('collections.index') }}" class="text-sm text-purple-300 hover:text-purple-200 transition-colors">
                        {{ __('egi.carousel.view_all') }} →
                    </a>
                </div>
            ...
            <div class="carousel-section">
                <div class="flex items-center justify-between mb-6">
                    ...
                    <a href="{{ route('collector.index') }}" class="text-sm text-purple-300 hover:text-purple-200 transition-colors">
                        {{ __('egi.carousel.view_all') }} →
                    </a>
                </div>
