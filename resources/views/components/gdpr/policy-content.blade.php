...
<article {{ $attributes->merge([
    ...
    <section class="p-6 mt-12 -mx-2 rounded-lg bg-gray-50"
        ...
        <address class="not-italic text-gray-700">
            ...
            <p class="mb-2">
                ...
                <a href="mailto:{{ config('gdpr.privacy_email') }}" class="text-blue-600 underline hover:text-blue-800">
            ...
            <p>
                ...
                <a href="mailto:{{ config('gdpr.dpo_email') }}" class="text-blue-600 underline hover:text-blue-800">
