                ...
                @if($notification->model)
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-3">
                        ...
                        <div class="bg-gray-700 p-3 rounded" aria-label="Royalty Mint">
                            ...
                            <p class="text-sm text-white" itemprop="comment">{{ $notification->model->royalty_mint }}%</p>
                        </div>
                        <div class="bg-gray-700 p-3 rounded" aria-label="Royalty Rebind">
                            ...
                            <p class="text-sm text-white" itemprop="comment">{{ $notification->model->royalty_rebind }}%</p>
                        </div>
                    </div>
