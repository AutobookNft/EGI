...
<head>
    ...
    {{-- Application Assets --}}
    @vite(['resources/css/app.css', 'resources/css/gdpr.css', 'resources/css/reservation-history.css', 'resources/css/mega-menu.css',
    'resources/js/app.js', 'resources/js/components/create-collection-modal.js', 'resources/js/reservation-history.js', 'resources/js/mega-menu-mobile.js'])
