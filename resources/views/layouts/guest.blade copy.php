...
<body class="bg-gray-50 text-gray-800">
    ...
    <header class="bg-white shadow-md" role="banner">
        ...
        <div class="flex items-center gap-4">
            ...
            <a href="{{ url('/home') }}" class="flex items-center gap-4 group" aria-label="{{ __('Frangette Home') }}">
        ...
        <nav class="flex items-center gap-6" role="navigation" aria-label="{{ __('Main navigation') }}">
            ...
            <a href="{{ url('/home/collections') }}" class="hover:text-green-600 transition">{{ __('Collections') }}</a>
