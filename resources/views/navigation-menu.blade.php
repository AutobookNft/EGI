                            ...
                            <div class="mega-menu-container bg-white/95 backdrop-blur-xl border border-gray-200/50 rounded-2xl shadow-2xl p-6 min-w-[380px] sm:min-w-[420px] lg:min-w-[500px] dark:bg-gray-900/95 dark:border-gray-700/50">
                                ...
                                <div class="grid grid-cols-1 gap-4 menu-grid sm:grid-cols-2">
                                    ...
                                    <div class="p-4 transition-all duration-300 border cursor-pointer menu-card group desktop-emerald bg-gradient-to-br from-emerald-50 to-teal-50 dark:from-emerald-900/20 dark:to-teal-900/20 rounded-xl border-emerald-200/30 dark:border-emerald-800/30 hover:shadow-lg hover:scale-105">
                                        ...
                                        <div class="space-y-2">
                                            <a href="{{ route('user.domains.personal-data') }}" class="block text-sm text-gray-600 transition-colors duration-200 dark:text-gray-300 hover:text-emerald-600 dark:hover:text-emerald-400">
                                                {{ __('menu.edit_personal_data') }}
                                            </a>
                                            @can('manage_profile')
                                                <a href="{{ route('profile.show') }}" class="block text-sm text-gray-600 transition-colors duration-200 dark:text-gray-300 hover:text-emerald-600 dark:hover:text-emerald-400">
                                                    {{ __('Profile') }}
                                                </a>
                                            @endcan
                                        </div>
                                    ...
                                    <div class="p-4 transition-all duration-300 border cursor-pointer menu-card group desktop-blue bg-gradient-to-br from-blue-50 to-indigo-50 dark:from-blue-900/20 dark:to-indigo-900/20 rounded-xl border-blue-200/30 dark:border-blue-800/30 hover:shadow-lg hover:scale-105">
                                        <div class="flex items-center mb-3 space-x-3">
                                            <div class="flex items-center justify-center w-10 h-10 text-white transition-transform duration-300 bg-blue-500 rounded-lg group-hover:scale-110">
                                                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        ...
                                        <div class="space-y-2">
                                            @can('manage_consents')
                                                <a href="{{ route('gdpr.consent') }}" class="block text-sm text-gray-600 transition-colors duration-200 dark:text-gray-300 hover:text-blue-600 dark:hover:text-blue-400">
                                                    {{ __('gdpr.menu.gdpr_center') }}
                                                </a>
                                            @endcan
                                            <a href="{{ route('gdpr.security') }}" class="block text-sm text-gray-600 transition-colors duration-200 dark:text-gray-300 hover:text-blue-600 dark:hover:text-blue-400">
                                                {{ __('menu.security_password') }}
                                            </a>
                                            <a href="{{ route('gdpr.profile-images') }}" class="block text-sm text-gray-600 transition-colors duration-200 dark:text-gray-300 hover:text-blue-600 dark:hover:text-blue-400">
                                                {{ __('menu.profile_images') }}
                                            </a>
                                            @can('gdpr.export_data')
                                                <a href="{{ route('gdpr.export-data') }}" class="block text-sm text-gray-600 transition-colors duration-200 dark:text-gray-300 hover:text-blue-600 dark:hover:text-blue-400">
                                                    {{ __('menu.export_data') }}
                                                </a>
                                            @endcan
                                        </div>
                                    ...
                                    @can('create_collection')
                                        <div class="p-4 transition-all duration-300 border cursor-pointer menu-card group desktop-purple bg-gradient-to-br from-purple-50 to-pink-50 dark:from-purple-900/20 dark:to-pink-900/20 rounded-xl border-purple-200/30 dark:border-purple-800/30 hover:shadow-lg hover:scale-105">
                                            <div class="flex items-center mb-3 space-x-3">
                                                <div class="flex items-center justify-center w-10 h-10 text-white transition-transform duration-300 bg-purple-500 rounded-lg group-hover:scale-110">
                                                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                            ...
                                            <div class="space-y-2">
                                                <a href="{{ route('collections.index') }}" class="block text-sm text-gray-600 transition-colors duration-200 dark:text-gray-300 hover:text-purple-600 dark:hover:text-purple-400">
                                                    {{ __('menu.my_collections') }}
                                                </a>
                                                <a href="{{ route('collections.create') }}" class="block text-sm text-gray-600 transition-colors duration-200 dark:text-gray-300 hover:text-purple-600 dark:hover:text-purple-400">
                                    ...
                                    <div class="p-4 transition-all duration-300 border cursor-pointer menu-card group desktop-orange bg-gradient-to-br from-orange-50 to-red-50 dark:from-orange-900/20 dark:to-red-900/20 rounded-xl border-orange-200/30 dark:border-orange-800/30 hover:shadow-lg hover:scale-105">
                                        <div class="flex items-center mb-3 space-x-3">
                                            <div class="flex items-center justify-center w-10 h-10 text-white transition-transform duration-300 bg-orange-500 rounded-lg group-hover:scale-110">
                                                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        ...
                                        <div class="space-y-2">
                                            @can('view_activity_log')
                                                <a href="{{ route('gdpr.activity-log') }}" class="block text-sm text-gray-600 transition-colors duration-200 dark:text-gray-300 hover:text-orange-600 dark:hover:text-orange-400">
                                                    {{ __('menu.activity_log') }}
                                                </a>
                                            @endcan
                                            @can('view_notifications')
                                                <a href="{{ route('notifications.index') }}" class="block text-sm text-gray-600 transition-colors duration-200 dark:text-gray-300 hover:text-orange-600 dark:hover:text-orange-400">
                                    ...
                                    @can('manage_roles')
                                        <div class="p-4 transition-all duration-300 border cursor-pointer menu-card group desktop-gray bg-gradient-to-br from-gray-50 to-slate-50 dark:from-gray-900/20 dark:to-slate-900/20 rounded-xl border-gray-200/30 dark:border-gray-800/30 hover:shadow-lg hover:scale-105 sm:col-span-2">
                                            <div class="flex items-center mb-3 space-x-3">
                                                <div class="flex items-center justify-center w-10 h-10 text-white transition-transform duration-300 bg-gray-600 rounded-lg group-hover:scale-110">
                                                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                            ...
                                            <div class="grid grid-cols-2 gap-2">
                                                <a href="{{ route('admin.roles.index') }}" class="block text-sm text-gray-600 transition-colors duration-200 dark:text-gray-300 hover:text-gray-900 dark:hover:text-gray-100">
                                                ...
                                                @can('view_statistics')
                                                    <a href="{{ route('statistics.index') }}" class="block text-sm text-gray-600 transition-colors duration-200 dark:text-gray-300 hover:text-gray-900 dark:hover:text-gray-100">
                                                        {{ __('menu.statistics') }}
                                                    </a>
                                                @endcan
                                            </div>
                                ...
                                <div class="pt-4 mt-6 border-t support-section border-gray-200/50 dark:border-gray-700/50">
                                    <div class="flex items-center justify-between">
                                        <div class="flex space-x-4">
                                            <a href="{{ route('gdpr.privacy-policy') }}" class="text-xs text-gray-500 transition-colors duration-200 hover:text-gray-700 dark:text-gray-400 dark:hover:text-gray-200">
                                                {{ __('menu.privacy_policy') }}
                                            </a>
                                            <a href="{{ route('gdpr.terms') }}" class="text-xs text-gray-500 transition-colors duration-200 hover:text-gray-700 dark:text-gray-400 dark:hover:text-gray-200">
                                                {{ __('menu.terms_of_service') }}
                                            </a>
                                            @can('contact_dpo')
                                                <a href="{{ route('gdpr.contact-dpo') }}" class="text-xs text-gray-500 transition-colors duration-200 hover:text-gray-700 dark:text-gray-400 dark:hover:text-gray-200">
                                                    {{ __('menu.contact_dpo') }}
                                                </a>
                                            @endcan
                                        </div>
                                ...
                                <div class="pt-4 mt-4 border-t action-section border-gray-200/50 dark:border-gray-700/50">
                                    <div class="flex items-center justify-between">
                                        @can('gdpr.delete_account')
                                            <a href="{{ route('gdpr.delete-account') }}" class="text-xs text-red-500 transition-colors duration-200 hover:text-red-700">
