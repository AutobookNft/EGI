...
<div id="editMetaModal"
    ...
    {{-- Panel --}}
    <div class="relative w-full max-w-2xl p-6 mx-auto bg-gray-900 border border-gray-700 rounded-xl shadow-xl">
        ...
        <form id="editMetaForm" class="space-y-4" autocomplete="off">
            ...
            <div class="flex justify-end gap-3 pt-2">
                <button type="button" class="px-4 py-2 font-medium text-gray-200 bg-gray-700 rounded hover:bg-gray-600" data-edit-cancel>
                    {{ __('collection.show.btn_cancel') }}
                </button>
                <button type="button" class="px-4 py-2 font-medium text-white rounded bg-emerald-600 hover:bg-emerald-700" data-edit-save>
                    {{ __('collection.show.btn_save') }}
                </button>
            </div>
        </form>
    </div>
