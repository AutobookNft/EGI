        ...
        <header class="mb-8 md:mb-12">
            ...
            <div class="bg-white p-4 sm:p-6 rounded-lg shadow-md">
                <form action="{{ route('home.collections.index') }}" method="GET" id="filterForm" class="flex flex-col md:flex-row md:items-end gap-4">
                    ...
                    {{-- <button type="submit" class="btn btn-secondary mt-4 md:mt-0 md:self-end">Apply Filters</button> --}}
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6 lg:gap-8">
            ...
            @empty
                ...
                <div class="col-span-full text-center py-16 px-4">
                    ...
                    <p class="text-gray-600 mb-6">{{ __('No collections match your current filters. Why not create one?') }}</p>
                    ...
                    @can('create_collection')
                        <a href="{{ route('collections.create') }}" {{-- Assicurati che questa rotta esista --}}
                           class="inline-flex items-center px-6 py-3 bg-green-600 border border-transparent rounded-md font-semibold text-sm text-white hover:bg-green-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-green-500 transition ease-in-out duration-150">
