                    ...
                    <div class="relative flex items-center justify-center p-4 lg:col-span-6 xl:col-span-7 lg:p-8">
                        ...
                        <div class="relative w-full max-w-5xl">
                            ...
                            <div class="absolute bottom-6 left-6 right-6 lg:bottom-8 lg:left-8 lg:right-8">
                                <div
                                    class="p-6 border shadow-2xl bg-black/80 backdrop-blur-xl rounded-xl border-white/10">
                                    <div class="flex items-start justify-between">
                                        <div class="flex-1">
                                            <h1 class="mb-2 text-2xl font-bold tracking-tight text-white lg:text-4xl">{{
                                                $egi->title }}</h1>
                                        ...
                                        <div class="flex items-center ml-4 space-x-2">
                                            ...
                                            <button
                                                ...
                                                <svg class="w-5 h-5 icon-heart {{ $egi->is_liked ?? false ? 'text-pink-400' : 'text-white' }}"
                                            ...
                                            {{-- Share Button --}}
                                            <button
                                                class="p-3 transition-all duration-200 border rounded-full bg-white/10 hover:bg-white/20 backdrop-blur-sm border-white/20"
