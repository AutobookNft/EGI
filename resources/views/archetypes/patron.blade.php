...
<body>
    ...
    <div id="app-container" itemscope itemtype="https://schema.org/WebPage">
        ...
        <aside class="sidebar" id="sidebar" role="navigation" aria-label="Menu di navigazione della pagina Mecenate">
            ...
            <nav id="sidebar-menu">
                ...
                <a href="#diventare" class="sidebar-link" role="menuitem">{{ __('patron.navigation.becoming_patron')
                    }}</a>
                <a href="#percorso" class="sidebar-link" role="menuitem">{{ __('patron.navigation.success_path') }}</a>
                <a href="#economico" class="sidebar-link" role="menuitem">{{ __('patron.navigation.economic_model')
                    }}</a>
                <a href="#storie" class="sidebar-link" role="menuitem">{{ __('patron.navigation.success_stories') }}</a>
                <a href="#strumenti" class="sidebar-link" role="menuitem">{{ __('patron.navigation.tools_support')
                    }}</a>
                <a href="#sfaccettature" class="sidebar-link" role="menuitem">{{ __('patron.navigation.role_facets')
                    }}</a>
                <a href="#faq" class="sidebar-link" role="menuitem">{{ __('patron.navigation.faq') }}</a>
                <a href="#pioneer" class="sidebar-link" role="menuitem">{{ __('patron.navigation.pioneer_program')
                    }}</a>
                <a href="#inizia" class="sidebar-link" role="menuitem">{{ __('patron.navigation.start_today') }}</a>
                <a href="#contatti" class="sidebar-link" role="menuitem">{{ __('patron.navigation.contacts_resources')
                    }}</a>
            </nav>
        </aside>
        ...
        <div class="main-content" role="main">
            ...
            <header>
                <div class="header-top-nav" role="navigation" aria-label="Navigazione tra gli attori della piattaforma">
                    ...
                    <a href="/home">{{ __('patron.global_nav.home') }}</a>
                    <a href="#">{{ __('patron.global_nav.creator') }}</a>
                    <a href="#">{{ __('patron.global_nav.collectors') }}</a>
                    <a href="#">{{ __('patron.global_nav.trader_pro') }}</a>
                    <a href="#">{{ __('patron.global_nav.epp') }}</a>
            ...
            <main>
                ...
                <section id="economico" class="section">
                    <h2>{{ __('patron.economic_model.title') }}</h2>
                    <h3>{{ __('patron.economic_model.subtitle') }}</h3>
                    <p style="text-align: center; margin-bottom: 30px;">{{ __('patron.economic_model.intro') }}</p>

                    <h4>{{ __('patron.economic_model.primary_market.title') }}</h4>
                    <table itemprop="offers" itemscope itemtype="https://schema.org/Table">
                        <thead>
                            <tr>
                                <th scope="col">{{ __('patron.economic_model.primary_market.table.global_volume') }}
                                </th>
                                <th scope="col">{{ __('patron.economic_model.primary_market.table.creator_patron') }}
                                </th>
                                <th scope="col">{{ __('patron.economic_model.primary_market.table.epp') }}</th>
                                <th scope="col">{{ __('patron.economic_model.primary_market.table.platform') }}</th>
                                <th scope="col">{{ __('patron.economic_model.primary_market.table.association') }}</th>
                            </tr>
                        </thead>
                        <tbody>
                            <tr>
                    ...
                    <p style="font-size: 0.9em; text-align: center;">{{ __('patron.economic_model.primary_market.note')
                        }}</p>

                    <h4>{{ __('patron.economic_model.secondary_market.title') }}</h4>
                    <table itemprop="offers" itemscope itemtype="https://schema.org/Table">
                        <thead>
                            <tr>
                                <th scope="col">{{ __('patron.economic_model.secondary_market.table.global_volume') }}
                                </th>
                                <th scope="col">{{ __('patron.economic_model.secondary_market.table.creator_patron') }}
                                </th>
                                <th scope="col">{{ __('patron.economic_model.secondary_market.table.epp') }}</th>
                                <th scope="col">{{ __('patron.economic_model.secondary_market.table.platform') }}</th>
                                <th scope="col">{{ __('patron.economic_model.secondary_market.table.association') }}
                                </th>
                                <th scope="col">{{ __('patron.economic_model.secondary_market.table.total') }}</th>
                            </tr>
                        </thead>
                        <tbody>
                            <tr>
                    ...
                    <p style="font-size: 0.9em; text-align: center;">{{
                        __('patron.economic_model.secondary_market.note') }}</p>
                </section>
                        ...
                        <div class="contact-block">
                            ...
                            <ul>
                                <li><i class="fas fa-envelope icon" aria-hidden="true"></i> <a
                                        href="mailto:academy@florenceegi.com" itemprop="email">{{
                                        __('patron.contacts.email') }}</a></li>
                                <li><i class="fab fa-whatsapp icon" aria-hidden="true"></i> <a
                                        href="https://wa.me/[numero]?text=MECENATE" itemprop="url">{{
                                        __('patron.contacts.whatsapp') }}</a></li>
                ...
                <section class="personal-message">
                    ...
                    <p>{{ __('patron.final_message.paragraph3') }} <strong>{{
                            __('patron.final_message.paragraph3_strong') }}</strong></p>
    ...
    <footer role="contentinfo">
        ...
        <p>&copy; 2025 {{ __('patron.footer.copyright') }} <a href="#">{{ __('patron.footer.privacy') }}</a> | <a
                href="#">{{ __('patron.footer.terms') }}</a></p>
    </footer>
