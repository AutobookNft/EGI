    ...
    <div class="max-w-4xl mx-auto">
        ...
        <nav class="p-6 mb-8 border shadow-lg bg-white/80 backdrop-blur-lg rounded-2xl border-gray-200/50"
            ...
            <ol class="space-y-2" role="list">
                @forelse($policyContent['sections'] as $index => $section)
                <li class="flex items-start">
                    <span class="flex-shrink-0 mr-3 font-medium text-gray-500">
                        {{ $section['index'] }}.
                    </span>
                    <a href="#{{ $section['anchor'] }}"
                    class="flex-1 text-blue-600 transition-colors hover:text-blue-800 hover:underline
            ...
            <div class="p-4 border border-yellow-200 rounded-lg bg-yellow-50"
                ...
                <div class="flex items-start">
                    ...
                    <div class="flex-1">
                        ...
                        <form method="POST" action="{{ route('gdpr.consent.update') }}" class="mt-4">
                            @csrf
