...
<x-guest-layout :title="__('guest_home.page_title')" :metaDescription="__('guest_home.meta_description')">
    {{-- Fix urgente per layout homepage --}}
    <style>
        /* Reset altezza viewport e overflow per hero section */
    #hero-section {
        height: auto !important;
        min-height: 100vh !important; /* Cambiato da unset a 100vh */
        max-height: none !important;
        overflow: visible !important;
        position: relative !important;
        padding: 80px 0 0 0 !important; /* Garantisce spazio per l'header fisso */
        margin: 0 !important;
        width: 100vw !important; /* Forza larghezza viewport */
    ...
    /* Assicuriamo che il hero content sia visibile */
    ...
    #backgroundCanvas {
        ...
        top: 0 !important;
        left: 0 !important;
        width: 100vw !important; /* Usa vw invece di % */
        height: 100vh !important; /* Usa vh invece di % */
        z-index: 0 !important;
    }
    /* Fix per il main content */
    main#main-content {
        overflow: visible !important;
        position: relative !important;
        z-index: 5 !important;
    ...
    /* Forzatura visibilità sezione statistiche */
    .nft-stats-section {
    ...
    /* Forza la visualizzazione di tutti gli elementi principali */
    section, .section, .py-16, .py-20 {
        display: block !important;
        height: auto !important;
    ...
    /* Colonne flessibili su schermi grandi */
    ...
    /* Fix per avatar images */
    .collection-card .w-4.h-4 {
    ...
    /* Griglia collezioni migliorata */
    .grid-cols-1.gap-6.md\:grid-cols-2.lg\:grid-cols-3.lg\:gap-8,
    .grid-cols-1.gap-6.sm\:grid-cols-2.md\:grid-cols-3.lg\:grid-cols-4.lg\:gap-8 {
        display: grid !important;
    ...
    /* Card NFT con proporzioni migliori */
    .collection-card-nft {
    ...
    .collection-card-nft .nft-glass-card {
        height: 100% !important;
        display: flex !important;
        flex-direction: column !important;
    }
    ...
    /* Migliora il canvas per l'effetto a tutto schermo */
    #backgroundCanvas {
    ...
    <x-slot name="headExtra">
        ...
        <style>
            /* Aggiungere al CSS esistente */
            main#main-content {
                padding-top: 6rem; /* Padding superiore per evitare sovrapposizioni */
                position: relative; /* Assicura posizionamento corretto */
                z-index: 5; /* Mantiene sopra i background */
            }


            /* Spazio per la prima sezione in main */
            main#main-content > section:first-child {
                margin-top: 4rem; /* Spazio aggiuntivo specifico per la prima sezione */
                position: relative;
                z-index: 6;
            }

            /* Spazio tra sezioni consecutive */
            main#main-content section + section {
                margin-top: 3rem;
            }

            /* Migliorare lo spazio sotto belowHeroContent */
            .hero-content-overlay .below-hero-content {
                padding-bottom: 4rem;
                margin-bottom: 2rem;
                position: relative;
                z-index: 10;
    ...
    <x-slot name="heroContentLeft">
        <div class="flex flex-col items-center gap-5">
            ...
            <div class="relative nft-rotating-border-container">
                ...
                <div
                    class="absolute inset-0 -m-4 rounded-full bg-gradient-radial from-amber-500/20 via-amber-400/10 to-transparent blur-2xl nft-pulse">
                </div>
                {{-- Bordo rotante NFT --}}
                ...
                <img src="/images/default/natan.png" alt="Natan"
                    class="relative z-10 block h-56 md:h-96 lg:h-[40rem] w-auto max-w-none mx-auto natan-pulse-only nft-hover-tilt" />
            </div>

            {{-- Badge narrativo style NFT collectible --}}
            <span
                class="flex items-center gap-2 px-5 py-4 mt-6 text-lg font-semibold text-blue-900 border shadow-md bg-gradient-to-br from-white/90 to-blue-100/80 border-blue-200/50 badge badge-narrative rounded-xl nft-glass-effect nft-hover-float">
                <svg class="w-5 h-5 text-blue-600 nft-pulse" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    <path
                        d="M15.7 4C15.7 4 16.3 5.2 16.3 7C16.3 8.8 15 10.3 13 10.3C11 10.3 9.2 8.8 9.2 7C9.2 5.2 9.8 4 9.8 4M2 22V19C2 16.8 6.1 15 11 15M18 14C19.5 14 21.5 14.3 23 15.1V22H13V18.9"
                ...
                {{-- NFT rarity badge --}}
                <span
                    class="ml-1 px-1.5 py-0.5 text-[10px] font-bold uppercase bg-gradient-to-r from-amber-400 to-yellow-600 text-white rounded nft-badge-shine">Legendary</span>
            </span>
    ...
    {{-- CENTRO: Carousel con Molecola sopra --}}
    <x-slot name="heroCarousel">
        <div class="relative flex flex-col items-center w-full">
            <div class="relative flex flex-col items-center">
                {{-- Glow effect sotto la molecola style NFT --}}
                <div
                    class="absolute rounded-full top-24 w-80 h-80 bg-gradient-radial from-cyan-400/20 via-cyan-500/10 to-transparent blur-xl nft-pulse">
                </div>
                <!-- Molecola SVG/logo con effetto NFT -->
                <div class="relative nft-3d-float">
                    <img src="/images/logo/logo_tr.png" alt="Equilibrium Molecule"
                        class="relative z-10 mb-2 w-96 animate-pulse natan-pulse-only" />

                    {{-- NFT verification badge --}}
                    <div
                        class="absolute flex items-center justify-center w-10 h-10 rounded-full -top-2 -right-2 bg-gradient-to-br from-blue-600 to-indigo-600 nft-badge-shine">
                ...
                <svg width="300" height="80"
                    class="absolute z-10 -translate-x-1/2 pointer-events-none top-2 left-1/2 natan-pulse-only"
                    ...
                    <text font-size="2rem" fill="url(#textGradient)" font-family="Montserrat, Arial, sans-serif"
                        letter-spacing="6" filter="url(#glow)" class="nft-shimmering-text">
            ...
            <div class="relative w-full p-1 mt-4 overflow-hidden rounded-xl nft-card-container">
                {{-- Bordo NFT animato --}}
                <div
                    class="absolute -inset-0.5 bg-gradient-to-r from-emerald-500 via-cyan-500 to-indigo-500 rounded-xl opacity-50 blur-sm nft-animated-border">
                </div>

                {{-- Contenuto carousel (mantenendo la chiamata originale) --}}
                <div class="relative z-10 overflow-hidden rounded-lg bg-gray-900/40 backdrop-blur-sm nft-glass-card">
                    {{-- Marketplace header --}}
                    <div
                        class="absolute top-0 left-0 right-0 z-20 flex items-center justify-between px-4 py-2 border-b bg-gradient-to-r from-gray-900/80 via-gray-900/60 to-gray-900/80 border-white/10">
                        ...
                        <div class="flex gap-1.5">
                            <div
                                class="px-2 py-0.5 text-[10px] font-medium bg-indigo-900/60 border border-indigo-500/40 text-indigo-300 rounded-full flex items-center gap-1">
                    ...
                    <div
                        class="absolute bottom-0 left-0 right-0 z-20 flex items-center justify-between px-4 py-2 border-t bg-gradient-to-r from-gray-900/80 via-gray-900/60 to-gray-900/80 border-white/10">
    ...
    {{-- DESTRA: Badge/Copy impatto --}}
    <x-slot name="heroContentRight">
        <div
            class="relative flex flex-col items-end gap-4 p-6 overflow-hidden border shadow-xl rounded-xl bg-gradient-to-br from-emerald-900/30 to-emerald-800/40 backdrop-blur-sm border-emerald-400/30 animate-hero-right-glow nft-hover-float nft-glass-card">
            {{-- NFT card header --}}
            <div
                class="absolute top-0 left-0 right-0 flex items-center justify-between px-4 py-2 border-b bg-gradient-to-r from-emerald-900/40 to-emerald-800/50 border-emerald-500/20">
                <div class="flex items-center gap-1.5">
                    <svg class="w-3.5 h-3.5 text-emerald-400" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                            d="M5 3v4M3 5h4M6 17v4m-2-2h4m5-16l2 2m0 0l2 2m-2-2l-2 2m0 0l-2 2" />
                    </svg>
            ...
            <div class="flex items-center gap-2 mt-4 animate-bounce-slow">
                ...
                <div class="p-2 border rounded-full bg-emerald-900/50 border-emerald-500/30 nft-pulse">
                    <svg class="w-7 h-7 text-emerald-400 animate-grow-leaf" fill="none" viewBox="0 0 24 24"
                        stroke="currentColor">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                            d="M12 21v-5m0 0c4.418 0 8-3.134 8-7v-.25C20 7 19 3 12 3 5 3 4 7 4 8.75V9c0 3.866 3.582 7 8 7z" />
                    </svg>
                </div>
                <span
                    class="text-lg font-bold tracking-wide text-transparent uppercase bg-clip-text bg-gradient-to-r from-emerald-300 to-emerald-100 drop-shadow nft-shimmering-text">
                    Impatto Reale
                </span>
            </div>
            ...
            <a href="{{ route('epps.index') }}"
                class="relative inline-block px-6 py-3 mt-2 overflow-hidden text-base font-semibold text-white transition duration-200 shadow-md bg-gradient-to-r from-emerald-500 to-teal-500 rounded-xl group nft-cta-button">
                <span class="absolute inset-0 bg-[url('/images/default/noise.png')] bg-repeat opacity-10"></span>
                <span
                    class="absolute transition opacity-25 -inset-1 bg-gradient-to-r from-emerald-500 via-cyan-500 to-teal-500 rounded-xl blur group-hover:opacity-40 nft-pulsing-border"></span>
            ...
            <div class="flex flex-wrap justify-end gap-2 mt-4">
                <div
                    class="px-3 py-1 rounded-full text-xs font-medium bg-emerald-900/60 border border-emerald-500/30 text-emerald-300 flex items-center gap-1.5 nft-badge-shine">
                    <span class="inline-block w-2 h-2 rounded-full bg-emerald-400 nft-pulse"></span>
                    Carbon Negative
                </div>
                <div
                    class="px-3 py-1 rounded-full text-xs font-medium bg-violet-900/60 border border-violet-500/30 text-violet-300 flex items-center gap-1.5 nft-badge-shine">
    ...
    <style>
        ...
        /* =========== Effetti specifici NFT =========== */

        /* Effetto testo brillante NFT style */
        .nft-text-glow {
    ...
    <script>
     ...
     <script>
        // Animazione contatore impatto realtime per engagement
        document.addEventListener('DOMContentLoaded', function() {
            ...
            if (impactCounter) {
                ...
                setInterval(() => {
                    // Aggiungi una piccola quantità casuale ogni 3 secondi (simulazione crescita realtime)
