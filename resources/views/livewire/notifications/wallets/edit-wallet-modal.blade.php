        ...
        @if($show)
            <div class="fixed inset-0 bg-black bg-opacity-50 z-50 flex justify-center items-center">
                <div class="bg-gray-800 p-6 rounded-2xl w-full max-w-md shadow-lg">
                        ...
                        <input type="hidden" name="user_id" value="{{ $receiverUserId }}">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="number" id="royaltyMint" name="royaltyMint"
                                class="input input-bordered input-primary w-full bg-gray-700 text-white"
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" id="royaltyRebind" name="royaltyRebind"
                                class="input input-bordered input-primary w-full bg-gray-700 text-white"
                        ...
                        <div class="flex justify-end space-x-4 mt-6">
                            ...
                            @if($mode === 'create')
                                <button type ="submit" class="btn btn-secondary">{{ __('label.save') }}</button>
                            @else
