<div id="image_of_collection" class="p-4 bg-gray-800 border border-gray-700 shadow-lg md:rounded-2xl md:p-6">
    ...
    <div class="grid grid-cols-1 gap-6 md:grid-cols-1">
        ...
        <div class="p-4 mt-6 transition-shadow duration-300 bg-gray-900 shadow-md rounded-xl hover:shadow-lg">
            ...
            <x-form-input :label="__('collection.collection_site_URL')" type="url" :datatip="__('collection.collection_site_URL_suggest')" model="url_collection_site"
                id="url_collection_site" :placeholder="__('collection.collection_site_URL')" width_label="w-full" width_input="w-full" :required="false"
