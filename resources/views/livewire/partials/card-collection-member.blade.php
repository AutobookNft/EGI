    ...
    <div class="flex items-start gap-4">
        ...
        <div class="relative">
            <div class="rounded-full bg-gradient-to-tr from-purple-600 to-blue-500 p-0.5">
                <img class="h-14 w-14 rounded-full border-2 border-gray-900"
        ...
        <div class="min-w-0 flex-1">
            <h3 class="bg-gradient-to-r from-purple-400 to-blue-500 bg-clip-text text-xl font-bold text-transparent">
