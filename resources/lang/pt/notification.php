...
/*
|--------------------------------------------------------------------------
| Traduzione in Portoghese di tutti i dati delle notifiche
|--------------------------------------------------------------------------
|
 */

 return [
    'proposal_declined_subject' => 'Sua proposta foi recusada',
    'proposal_declined_line' => 'Sua proposta foi recusada.',
    'proposal_declined_reason' => 'Motivo:',
    'proposal_declined_id' => 'ID da proposta:',
    'view_details' => 'Ver detalhes',
    'thank_you' => 'Obrigado por usar nossa plataforma.',
    ...
    'notification_list_error' => 'Erro ao carregar a lista de notificações',
];
