    ...
    */
    'errors' => [
        ...
        'PERMISSION_BASED_REGISTRATION_FAILED' => [
            'type' => 'server_error',
            'blocking' => true,
            'message' => 'error_manager.permission_based_registration_failed',
            'user_message' => 'error_manager.permission_based_registration_failed_user',
            'notifiable' => true,
        ...
        'ALGORAND_WALLET_GENERATION_FAILED' => [
            'type' => 'server_error',
            'blocking' => true,
            'message' => 'error_manager.algorand_wallet_generation_failed',
            'user_message' => 'error_manager.algorand_wallet_generation_failed_user',
            'notifiable' => true,
            'notifications' => ['log', 'db'],
            'msg_to' => 'toast',
            'log_level' => 'error',
        ...
        'ECOSYSTEM_SETUP_FAILED' => [
            'type' => 'server_error',
            'blocking' => true,
            'message' => 'error_manager.ecosystem_setup_failed',
            'user_message' => 'error_manager.ecosystem_setup_failed_user',
            'notifiable' => true,
            'notifications' => ['log', 'db'],
            'msg_to' => 'toast',
            'log_level' => 'error',
        ...
        'USER_DOMAIN_INITIALIZATION_FAILED' => [
            'type' => 'server_error',
            'blocking' => false, // Non blocking - l'utente può completare i domini dopo
            'message' => 'error_manager.user_domain_initialization_failed',
            'user_message' => 'error_manager.user_domain_initialization_failed_user',
            'notifiable' => true,
            'notifications' => ['log'],
            'msg_to' => 'toast',
            'log_level' => 'warning',
        ...
        'GDPR_CONSENT_PROCESSING_FAILED' => [
            'type' => 'server_error',
            'blocking' => true,
            'message' => 'error_manager.gdpr_consent_processing_failed',
            'user_message' => 'error_manager.gdpr_consent_processing_failed_user',
            'notifiable' => true,
            'notifications' => ['log', 'db'],
            'msg_to' => 'toast',
            'log_level' => 'error',
        ...
        'ROLE_ASSIGNMENT_FAILED' => [
            'type' => 'server_error',
            'blocking' => true,
            'message' => 'error_manager.role_assignment_failed',
            'user_message' => 'error_manager.role_assignment_failed_user',
            'notifiable' => true,
            'notifications' => ['log', 'db'],
            'msg_to' => 'toast',
            'log_level' => 'error',
        ...
        'REGISTRATION_PAGE_LOAD_ERROR' => [
            'type' => 'server_error',
            'blocking' => false,
            'message' => 'error_manager.registration_page_load_error',
            'user_message' => 'error_manager.registration_page_load_error_user',
            'notifiable' => true,
            'notifications' => ['log'],
            'msg_to' => 'toast',
            'log_level' => 'warning',
