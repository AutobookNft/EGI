...
return new class extends Migration {
    ...
    public function up(): void {
        Schema::table('reservations', function (Blueprint $table) {
            ...
            // 4. Modificare offer_amount_algo da DECIMAL a BIGINT per microALGO
            ...
            // 5. Aggiungere i campi mancanti per la gestione completa della valuta
            ...
            if (!Schema::hasColumn('reservations', 'exchange_timestamp')) {
                $table->timestamp('exchange_timestamp')->comment('Timestamp del tasso di cambio');
            }
