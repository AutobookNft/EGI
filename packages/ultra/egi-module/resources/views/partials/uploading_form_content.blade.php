...
<div class="p-5 bg-gradient-to-br from-gray-800 via-purple-900 to-blue-900 rounded-xl shadow-xl border border-purple-500/30 relative nft-background" id="upload-container" data-upload-type="egi">
    ...
    <div class="mt-6 flex justify-center space-x-4">
        <button type="button" id="uploadBtn" class="relative bg-green-500 text-white px-5 py-2.5 rounded-full font-semibold text-base nft-button opacity-50 cursor-not-allowed disabled:hover:bg-green-500 disabled:hover:shadow-none group" aria-label="{{ trans('uploadmanager::uploadmanager.save_aria') }}">
        ...
        <button type="button" onclick="cancelUpload()" id="cancelUpload" class="relative bg-red-500 text-white px-5 py-2.5 rounded-full font-semibold text-base nft-button opacity-50 cursor-not-allowed disabled:hover:bg-red-500 disabled:hover:shadow-none group" aria-label="{{ trans('uploadmanager::uploadmanager.cancel_aria') }}">
    ...
    <!-- Previews grid -->
    <div id="collection" class="mt-6 grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-4">
    ...
    <div class="mt-6 text-center">
        <p class="text-gray-200 text-xs"><span id="scan-progress-text"></span></p>
    </div>

    <!-- Status showEmoji-->
    <div id="status" class="mt-4 text-center text-gray-200 text-xs mx-auto w-32 p-2"></div>

    <!-- Upload status -->
    <div id="upload-status" class="mt-5 text-center text-gray-200">
        <p id="status-message" class="text-xs">{{ trans('uploadmanager::uploadmanager.preparing_to_mint') }}</p>
    </div>
</div>
