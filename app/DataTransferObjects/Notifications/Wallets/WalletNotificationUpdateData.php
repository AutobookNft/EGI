...
class WalletNotificationUpdateData implements NotificationDataInterface
{
    public function __construct(
        ...
        private readonly ?float $proposal_royalty_mint = null,
        private readonly ?float $proposal_royalty_rebind = null,
    ...
    public function getProposalRoyaltyMint(): ?float
    {
        return $this->proposal_royalty_mint;
    }
    public function getProposalRoyaltyRebind(): ?float
    {
        return $this->proposal_royalty_rebind;
    }
    ...
    public static function forAcceptance(
        ...
        string $status,
        ?float $Old_royalty_mint = null,
        ?float $Old_royalty_rebind = null,
        ?float $proposal_royalty_mint = null,
        ?float $proposal_royalty_rebind = null,
        ...
        return new self(
            ...
            proposal_royalty_mint: $proposal_royalty_mint,
            proposal_royalty_rebind: $proposal_royalty_rebind,
        );
    }
    ...
    public function toArray(): array
    {
        return [
            ...
            'proposal_royalty_mint' => $this->proposal_royalty_mint,
            'proposal_royalty_rebind' => $this->proposal_royalty_rebind,
        ];
    }
