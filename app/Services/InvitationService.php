        ...
        return DB::transaction(function () use ($collection, $email, $role) {
            ...
            try{
                ...
                $data = [
                    ...
                    'proposer_id' => Auth::id(), // Proposer: è l'utente autenticato che fa la proposta
                ...
                $invitation['proposer_email'] = Auth::user()->email; // Email di chi fa la proposta
                ...
                $invitation['view'] = 'invitations.' . NotificationStatus::REQUEST->value;
