...
class UltraCompileTestCommand extends Command
{
    protected $signature = 'ultra_test:compile {module : The name of the Ultra module (e.g., UltraConfigManager)}'; // Rimosso default, reso obbligatorio
    ...
    public function handle(Filesystem $filesystem): int // Inietta Filesystem per testabilità (opzionale, Facade ok)
    {
        ...
        $outputPath = "/home/fabio/libraries" . DIRECTORY_SEPARATOR . "{$projectCode}_TestOutput"; // Directory di output dedicata
