 ...
 * @version   1.0.0
 * @date      2025-06-11
 * @solution  Represents the notification sent when a data processing restriction has been applied.
 *
 * --- OS1 DOCUMENTATION ---
 * @oracode-intent: To encapsulate the data and delivery channels for a 'processing restricted' notification.
 * @os1-compliance: Full.
 */
class ProcessingRestrictedNotification extends AbstractGdprNotification
{
    /**
