 ...
 * @version   1.0.0
 * @date      2025-06-11
 * @solution  Represents the notification sent when a user's data export is ready for download.
 *
 * --- OS1 DOCUMENTATION ---
 * @oracode-intent: To encapsulate the data and delivery channels for a 'data exported' notification.
 * @os1-compliance: Full.
 */
class DataExportedNotification extends AbstractGdprNotification
{
    /**
