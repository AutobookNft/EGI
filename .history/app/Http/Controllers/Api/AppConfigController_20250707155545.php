...
class AppConfigController extends Controller
{
    ...
    /**
     * @Oracode Get assistant translation keys
     * 🎯 Purpose: Map assistant translation keys to simplified names
     * 📥 Input: None
     * 📤 Output: Array of key mappings
     *
    ...
    private function getAssistantTranslationMappings(): array
    {
        return [
            ...
            'natan.header.title' => 'assistant.header.title',
            'natan.header.subtitle' => 'assistant.header.subtitle',
            'natan.welcome' => 'assistant.welcome',
            'natan.dismiss' => 'assistant.dismiss',
        ];
    }
