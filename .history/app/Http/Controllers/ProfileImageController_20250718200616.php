...
class ProfileImageController extends \App\Http\Controllers\Controller
{
    ...
    public function uploadImage(Request $request)
    {
        try {
            ...
            if ($user->getAllProfileImages()->count() === count($uploadedMedia)) {
                $this->setCurrentProfileImage($user, $uploadedMedia[0]);
            }
    ...
    public function setCurrentImage(Request $request): RedirectResponse
    {
        ...
        try {
            ...
            $this->setCurrentProfileImage($user, $media);
    ...
    /**
     * Set current profile image using profile_photo_path field
     *
     * @param \App\Models\User $user
     * @param \Spatie\MediaLibrary\MediaCollections\Models\Media $media
     * @return void
     */
    private function setCurrentProfileImage($user, $media)
    {
        // Update the profile_photo_path field with the media path
        $user->update([
            'profile_photo_path' => $media->getPath()
        ]);
    }
    ...
    public function deleteImage(Request $request): RedirectResponse
    {
        ...
        try {
            ...
            $isCurrent = $user->profile_photo_path === $media->getPath();
            ...
            if ($isCurrent) {
                ...
                if ($nextImage) {
                    $this->setCurrentProfileImage($user, $nextImage);
                } else {
