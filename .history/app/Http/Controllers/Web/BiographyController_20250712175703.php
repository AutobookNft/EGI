...
class BiographyController extends Controller
{
    ...
    public function uploadMedia(Request $request): \Illuminate\Http\JsonResponse
    {
        ...
        try {
            ...
            // Per ora gestisci sempre come media temporanei e collega al salvataggio
            $file = $request->file('file');
            $collection = $request->input('collection');

            // Salva temporaneamente il file
            $tempPath = $file->store('temp/biography-media', 'public');
            ...
            $this->logger->info('Biography web: media uploaded temporarily', [
                'user_id' => auth()->id(),
