    ...
    public function uploadImage(Request $request)
    {
        try {
            ...
            Log::info('Profile image upload request', [
                ...
                'profile_image_type' => gettype($request->file('profile_image')),
                'is_array' => is_array($request->file('profile_image')),
                'count' => $request->file('profile_image') ? count($request->file('profile_image')) : 0
            ]);
