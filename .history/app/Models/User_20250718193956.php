...
class User extends Authenticatable implements HasMedia
{
     ...
     * 🎯 Purpose: Get the currently active profile image
     ...
     * 🎯 Purpose: Set a specific image as the current profile photo
     * 📤 Returns: Boolean success status
     */
    public function setCurrentProfileImage(Media $media): bool
    {
        // Clear current profile collection
        $this->clearMediaCollection('current_profile');

        // Copy the selected image to current_profile collection
        $media->copy($this, 'current_profile');
     ...
     * 🎯 Purpose: Override default profile photo URL to use Spatie media
