...
class BiographyEditor extends Component
{
    ...
    public function save()
    {
        ...
        try {
            ...
            // Reload media data from saved biography (now handled by Spatie Media Library)
            $this->loadMediaData($biography);
    ...
    /**
     * Load media data from biography using Spatie Media Library
     */
    private function loadMediaData($biography)
    {
        $this->mediaData = [];
