...
class BiographyEditor extends Component
{
    ...
    /**
     * Add media data from JavaScript upload
     */
    public function addMediaData($mediaData)
    {
     ...
     * Remove media data
     */
    public function removeMediaData($mediaId)
    {
        $this->mediaData = array_filter($this->mediaData, function ($media) use ($mediaId) {
            return $media['id'] !== $mediaId;
        });

        $this->mediaData = array_values($this->mediaData); // Reindex
