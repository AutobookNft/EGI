                ...
                <div class="relative max-w-4xl px-4 py-16 mx-auto sm:px-6 lg:px-8">
                    <div class="text-center">
                        ...
                        <div class="mb-8">
                            ...
                            @else
                                <div class="mx-auto mb-4 flex h-24 w-24 items-center justify-center rounded-full bg-[#D4A574]">
            ...
            <div class="max-w-4xl px-4 py-12 mx-auto sm:px-6 lg:px-8">
                ...
                <div class="mb-16">
                    ...
                    <div class="p-8 mb-8 border-2 border-[#D4A574] rounded-2xl bg-gradient-to-br from-gray-800/60 to-gray-900/60 backdrop-blur-sm shadow-2xl">
                        <div class="prose prose-lg prose-invert max-w-none biography-content">
                            {!! $biography->content !!}
                        </div>
                    </div>
                        ...
                        <div class="relative flex justify-center">
                            <div class="px-6 py-3 bg-gradient-to-r from-[#1B365D] to-[#2D5016] rounded-full border-2 border-[#D4A574]">
                                <div class="flex items-center space-x-3">
                                    ...
                                    <span class="text-xl font-bold text-white">{{ __('biography.chapters_section_title') }}</span>
                                    <svg class="w-6 h-6 text-[#D4A574]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 11H5m14 0a2 2 0 012 2v6a2 2 0 01-2 2H5a2 2 0 01-2-2v-6a2 2 0 012-2m14 0V9a2 2 0 00-2-2M5 11V9a2 2 0 012-2m0 0V5a2 2 0 012-2h6a2 2 0 012 2v2M7 7h10"></path>
                                    </svg>
                                </div>
                                ...
                                <div class="p-6 border-b border-gray-700">
                                    ...
                                    <div class="flex items-center space-x-4 text-sm text-gray-400">
                                        ...
                                        @if ($chapter->chapter_type)
                                            <span class="inline-flex items-center rounded-full bg-[#1B365D] px-2.5 py-0.5 text-xs font-medium text-white">
                ...
                <!-- Author CTA -->
                <div class="mt-12 rounded-xl border border-gray-700 bg-gradient-to-r from-[#1B365D]/50 to-[#2D5016]/50 p-8 text-center">
