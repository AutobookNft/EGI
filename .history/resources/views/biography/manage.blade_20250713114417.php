                    ...
                    <div class="flex space-x-4">
                        @if ($user->biographies()->exists())
                            <a href="{{ route('biography.view') }}"
                                class="inline-flex items-center px-4 py-2 text-white transition-colors bg-gray-700 border border-gray-600 rounded-lg hover:bg-gray-600">
                        ...
                        <div
                                ...
                                <div class="flex items-center space-x-2">
                                    ...
                                    <div class="flex items-center space-x-1">
                                        @if ($biography->is_public)
                                            <span
                                                class="inline-flex items-center px-2 py-1 text-xs font-medium text-green-300 rounded-full bg-green-900/50">
                                        ...
                                        @else
                                            <span
                                                class="inline-flex items-center px-2 py-1 text-xs font-medium text-gray-300 rounded-full bg-gray-900/50">
                                                <svg class="w-3 h-3 mr-1" fill="currentColor" viewBox="0 0 20 20">
                                                    <path fill-rule="evenodd"
                                        ...
                                        @if ($biography->is_completed)
                                            <span
                                                class="inline-flex items-center px-2 py-1 text-xs font-medium text-blue-300 rounded-full bg-blue-900/50">
                                                <svg class="w-3 h-3 mr-1" fill="currentColor" viewBox="0 0 20 20">
                                                    <path fill-rule="evenodd"
                            ...
                            <div class="flex space-x-2">
                                ...
                                <button onclick="deleteBiography({{ $biography->id }})"
                                    class="inline-flex items-center px-3 py-2 text-red-300 transition-colors rounded-lg bg-red-900/50 hover:bg-red-900">
