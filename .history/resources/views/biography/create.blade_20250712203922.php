...
<div class="min-h-screen bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900 py-12">
    <div class="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8">
        <div class="bg-gray-800/50 backdrop-blur-sm border border-gray-700 rounded-xl p-8 shadow-2xl">
            ...
            <!-- Header -->
            <div class="mb-8">
                <h1 class="text-3xl font-bold text-white mb-2">Crea Nuova Biografia</h1>
            ...
            <!-- Form -->
            <form action="{{ route('biography.store') }}" method="POST" enctype="multipart/form-data" id="biography-form">
                @csrf
                        ...
                        <div class="space-y-6">
                            ...
                            <div>
                                ...
                                <select id="type" name="type"
                                    ...
                                    <option value="single" {{ old('type') == 'single' ? 'selected' : '' }}>Biografia Singola</option>
                                    <option value="chapters" {{ old('type') == 'chapters' ? 'selected' : '' }}>Biografia a Capitoli</option>
                                </select>
                                @error('type')
                                    <p class="mt-1 text-sm text-red-400">{{ $message }}</p>
                                @enderror
                            ...
                            <div>
                                ...
                                <p class="mt-1 text-xs text-gray-400">
                                    Descrizione breve che apparirà in anteprima (<span id="excerpt-count">{{ strlen(old('excerpt') ?? '') }}</span>/500)
                                </p>
                                @error('excerpt')
                                    <p class="mt-1 text-sm text-red-400">{{ $message }}</p>
                                @enderror
                        ...
                        <div class="space-y-6">
                            ...
                            <div>
                                ...
                                <p class="text-xs text-gray-400">
                                    Carica le immagini per la tua biografia. Formati supportati: JPG, PNG, WEBP (Max 2MB ciascuna)
                                </p>
                            ...
                            <div class="space-y-4">
                                <div class="flex items-center justify-between">
                                    ...
                                    <label class="relative inline-flex cursor-pointer items-center">
                                        <input type="checkbox" name="is_public" id="is_public" class="peer sr-only" {{ old('is_public') ? 'checked' : '' }}>
