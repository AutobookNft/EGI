        ...
        @if ($biography)
            ...
            <div class="max-w-4xl px-4 py-12 mx-auto sm:px-6 lg:px-8">
                    ...
                    <div class="mb-12">
                        ...
                        <div class="grid grid-cols-1 gap-6 md:grid-cols-2 lg:grid-cols-3">
                            @foreach ($biography->getMedia('main_gallery') as $media)
                                <div class="relative overflow-hidden transition-transform border border-gray-700 group rounded-xl bg-gray-800/50 backdrop-blur-sm hover:scale-105">
                ...
                @if ($biography->getFirstMedia('featured_image'))
                    ...
                    <div class="mb-12">
                        <h3 class="mb-6 text-2xl font-semibold text-white">
                            {{ __('biography.featured_image') }}
                        </h3>
                        <div class="overflow-hidden border border-gray-700 rounded-xl bg-gray-800/50">
                            ...
                            @if ($featuredImage->getCustomProperty('caption'))
                                <div class="p-4">
                                    <p class="text-gray-300">{{ $featuredImage->getCustomProperty('caption') }}</p>
                                </div>
                            @endif
                        </div>
                    </div>
