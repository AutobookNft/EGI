<x-app-layout>
        ...
        <div class="rounded-xl border border-gray-700 bg-gray-800/50 p-8 shadow-2xl backdrop-blur-sm">
            ...
            <form
                ...
                <div id="basic-tab" class="space-y-6">
                    ...
                    <div>
                        <label for="title"
                            class="mb-2 block text-sm font-medium text-gray-300">{{ __('biography.edit_page.title_required') }}</label>
                    ...
                    <div>
                        <label for="content"
                            class="mb-2 block text-sm font-medium text-gray-300">{{ __('biography.edit_page.content_required') }}</label>
                    ...
                    <div>
                        <label for="excerpt"
                            class="mb-2 block text-sm font-medium text-gray-300">{{ __('biography.edit_page.excerpt') }}</label>
                    ...
                    @if (isset($chapters) && $chapters->count() > 0)
                        <div id="biography-chapters-list" class="mt-10 space-y-6">
                            @foreach ($chapters as $chapter)
                                <div class="mb-6 rounded-xl bg-gray-800/60 p-6 shadow-lg"
                                    ...
                                    <div class="mb-2 flex items-center justify-between">
                                        ...
                                        <div class="flex space-x-2">
                                            ...
                                            <button type="button"
                                                class="delete-chapter-btn rounded bg-red-700 px-2 py-1 text-white hover:bg-red-600"
                                    ...
                                    <div class="prose prose-invert mb-2 max-w-none text-white">{!! $chapter->content !!}
                                    </div>
                                            ...
                                            <div class="flex flex-wrap gap-2">
                                                @foreach ($chapter->media as $media)
                                                    <img src="{{ $media['thumb_url'] ?? $media['url'] }}"
                                                        class="h-20 w-20 rounded object-cover shadow" alt="media",
                ...
                <div id="media-tab" class="hidden space-y-6">
                    <div class="space-y-6">
                        ...
                        <div>
                            <label
                                class="mb-2 block text-sm font-medium text-gray-300">{{ __('biography.edit_page.biography_images') }}</label>
    ...
    <div id="chapter-modal" class="fixed inset-0 z-50 ml-80 flex hidden items-center justify-center bg-black/60">
        <div class="relative w-full max-w-2xl rounded-xl bg-gray-900 p-8 shadow-2xl">
            <button id="close-chapter-modal"
                class="absolute right-4 top-4 text-2xl text-gray-400 hover:text-white">&times;</button>
