<x-app-layout>
    <x-slot name="title">Modifica Biografia</x-slot>
    ...
    <div class="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
        <div class="rounded-xl border border-gray-700 bg-gray-800/50 p-8 shadow-2xl backdrop-blur-sm">
            ...
            <!-- Header -->
            <div class="mb-8">
                <h1 class="mb-2 text-3xl font-bold text-white">Modifica Biografia</h1>
            ...
            <!-- Form -->
            <form action="{{ route('biography.update', $biography) }}" method="POST" enctype="multipart/form-data"
                id="biography-form">
                @csrf
                @method('PUT')
                        ...
                        <div class="space-y-6">
                            ...
                            <div>
                                ...
                                <select id="type" name="type"
                                    ...
                                    <option value="single"
                                        {{ old('type', $biography->type) == 'single' ? 'selected' : '' }}>Biografia
                                        Singola</option>
                                    <option value="chapters"
                                        {{ old('type', $biography->type) == 'chapters' ? 'selected' : '' }}>
                            ...
                            <div>
                                ...
                                <p class="mt-1 text-xs text-gray-400">
                                    Descrizione breve che apparirà in anteprima (<span
                                        id="excerpt-count">{{ strlen(old('excerpt', $biography->excerpt) ?? '') }}</span>/500)
                                </p>
                                @error('excerpt')
                                    <p class="mt-1 text-sm text-red-400">{{ $message }}</p>
                                @enderror
                        ...
                        <div class="space-y-6">
                                    ...
                                    <div class="grid grid-cols-1 gap-6 md:grid-cols-2 lg:grid-cols-3"
                                        ...
                                        @foreach ($biography->media as $media)
                                            <div class="group relative">
                                                <div
                                                    class="relative aspect-square overflow-hidden rounded-lg bg-gray-900">
                                                    ...
                                                    <div
                                                        ...
                                                        <button type="button"
                                                            ...
                                                            class="rounded-full bg-red-500 p-2 text-white opacity-0 transition-all hover:bg-red-600 group-hover:opacity-100">
                                                ...
                                                <div class="mt-2 truncate text-sm text-gray-300">
                                                    {{ $media->name }}
                                                </div>
                                            </div>
                                        @endforeach
                            ...
                            <div>
                                ...
                                <p class="text-xs text-gray-400">
                                    Carica nuove immagini per la tua biografia. Formati supportati: JPG, PNG, WEBP
                                    (Max 2MB ciascuna)
                                </p>
                                ...
                                <div class="flex items-center justify-between">
                                    ...
                                    <label class="relative inline-flex cursor-pointer items-center">
                                        <input type="checkbox" name="is_public" id="is_public" class="peer sr-only"
                                            {{ old('is_public', $biography->is_public) ? 'checked' : '' }}>
                                        <div
