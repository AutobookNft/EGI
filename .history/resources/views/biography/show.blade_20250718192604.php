        ...
        @if ($biography)
            ...
            <div class="max-w-4xl px-4 py-12 mx-auto sm:px-6 lg:px-8">
                ...
                <div class="mb-16">
                    ...
                    <div
                        class="mb-8 rounded-2xl border-2 border-[#D4A574] bg-gradient-to-br from-gray-800/60 to-gray-900/60 p-6 shadow-2xl backdrop-blur-sm">
                        <div class="prose-sm prose biography-content prose-invert max-w-none">
                            {!! $biography->content !!}
                        </div>
                    </div>
