        ...
        @if($activeTab === 'media')
            <div class="space-y-6">
                ...
                <div>
                    ...
                    <div class="space-y-4">
                        <input type="file"
                               ...
                               wire:target="featuredImage">
                        <p class="text-xs text-gray-400">
                            {{ __('biography.form.featured_image_hint') }}
                        </p>

                        <!-- Loading indicator -->
                        <div wire:loading wire:target="featuredImage" class="flex items-center space-x-2 text-[#D4A574]">
                            <div class="animate-spin rounded-full h-4 w-4 border-b-2 border-[#D4A574]"></div>
                ...
                <div>
                    ...
                    <input type="file"
                           wire:model.defer="galleryImages"
                           multiple
                           accept="image/*"
                           class="w-full px-4 py-3 bg-gray-800 border border-gray-600 rounded-lg text-white file:mr-4 file:py-2 file:px-4 file:rounded-lg file:border-0 file:text-sm file:font-medium file:bg-[#D4A574] file:text-gray-900 hover:file:bg-[#E6B885] transition-colors"
                           wire:loading.attr="disabled"
                           wire:target="galleryImages">
                    <!-- Loading indicator -->
                    <div wire:loading wire:target="galleryImages" class="flex items-center space-x-2 text-[#D4A574] mt-2">
                        <div class="animate-spin rounded-full h-4 w-4 border-b-2 border-[#D4A574]"></div>
