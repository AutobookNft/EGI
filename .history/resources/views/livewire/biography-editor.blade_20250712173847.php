            ...
            <div class="space-y-6" x-data="mediaUploadManager()">
                ...
                <div>
                    ...
                    <p class="text-xs text-gray-400">
                        Carica tutte le immagini per la tua biografia. Potrai selezionare una come immagine featured e una come avatar.
                    </p>
                    ...
                    <!-- Error message -->
                    <div x-show="multipleImagesError" x-transition class="mt-1 text-sm text-red-400" x-text="multipleImagesError"></div>
                                    ...
                                    <div class="space-y-3">
                                        ...
                                        <div class="flex items-center space-x-2">
                                            <input type="radio"
                                                ...
                                                name="featured_image"
                                                :value="image.id"
                                                x-model="selectedFeaturedImageId"
                                                class="h-4 w-4 text-[#D4A574] bg-gray-700 border-gray-600 focus:ring-[#D4A574] focus:ring-2">
                                            <label :for="'featured-' + image.id" class="text-sm font-medium text-gray-300 cursor-pointer">
                                        ...
                                        <div class="flex items-center space-x-2">
                                            <input type="radio"
                                                ...
                                                class="h-4 w-4 text-[#D4A574] bg-gray-700 border-gray-600 focus:ring-[#D4A574] focus:ring-2">
                                            <label :for="'avatar-' + image.id" class="text-sm font-medium text-gray-300 cursor-pointer">
                                                <span class="flex items-center space-x-2">
