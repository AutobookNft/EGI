...
@push('scripts')
    ...
    <script>
        ...
        function handleSave() {
            ...
            let contentToSave = '';
            let chapterContentToSave = '';

            if (contentEditor && contentEditor.editor) {
                contentToSave = contentEditor.editor.getDocument().toString();
            }
            if (chapterContentEditor && chapterContentEditor.editor) {
                chapterContentToSave = chapterContentEditor.editor.getDocument().toString();
            }

            @this.call('saveBiography', contentToSave, chapterContentToSave);
        }
    </script>
@endpush
