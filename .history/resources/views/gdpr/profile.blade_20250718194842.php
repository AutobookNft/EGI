                    ...
                    <form action="{{ route('profile.upload-image') }}" method="POST" enctype="multipart/form-data"
                        ...
                        <div class="rounded-lg border-2 border-dashed border-gray-300 p-6 text-center">
                            ...
                            <label for="profile_image" class="block cursor-pointer">
                                <svg class="mx-auto mb-4 h-12 w-12 text-gray-400" fill="none"
                                    stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                        d="M7 16a4 4 0 01-.88-7.903A5 5 0 1115.9 6L16 6a5 5 0 011 9.9M15 13l-3-3m0 0l-3 3m3-3v12" />
                                </svg>
                                <p class="gdpr-subtitle text-sm">{{ __('profile.click_to_upload') }}</p>
                                <p class="mt-1 text-xs text-gray-500">{{ __('profile.supported_formats') }}</p>
                            </label>
                        </div>
                        <button type="submit"
                            class="gdpr-btn-primary inline-flex w-full items-center justify-center rounded-lg px-4 py-2 text-sm">
                            <svg class="mr-2 h-4 w-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                    d="M7 16a4 4 0 01-.88-7.903A5 5 0 1115.9 6L16 6a5 5 0 011 9.9M15 13l-3-3m0 0l-3 3m3-3v12" />
                            </svg>
