            ...
            <div class="space-y-6">
                ...
                <div class="gdpr-card rounded-2xl p-6">
                    ...
                    <form action="{{ route('profile.upload-image') }}" method="POST" enctype="multipart/form-data"
                        ...
                        {{-- Upload Area --}}
                        <div class="rounded-lg border-2 border-dashed border-gray-300 p-8 text-center transition-colors hover:border-oro-fiorentino hover:bg-gray-50/50" id="upload-area">
                            ...
                            <label for="profile_image" class="block cursor-pointer">
                                ...
                                <p class="gdpr-subtitle text-lg font-medium">{{ __('profile.drag_drop_or_click') }}</p>
