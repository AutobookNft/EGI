            ...
            <div class="space-y-6">
                ...
                <div class="gdpr-card rounded-2xl p-6">
                    ...
                    <a href="{{ route('gdpr.export-data') }}"
                        class="gdpr-btn-primary inline-flex items-center rounded-lg px-4 py-2 text-sm">
                ...
                <div class="gdpr-card rounded-2xl border-red-200 p-6">
                    <div class="mb-4 flex items-center justify-between">
                        <h3 class="text-lg font-semibold" style="color: var(--rosso-urgenza);">
                            {{ __('profile.account_deletion') }}
                        </h3>
                        <svg class="h-6 w-6" style="color: var(--rosso-urgenza);" fill="none"
                            stroke="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                d="M19 7l-.867 12.142A2 2 0 0116.138 21H7.862a2 2 0 01-1.995-1.858L5 7m5 4v6m4-6v6m1-10V4a1 1 0 00-1-1h-4a1 1 0 00-1-1H8a1 1 0 00-1 1v3M4 7h16" />
                        </svg>
                    </div>
                    <div class="gdpr-alert-error mb-4 rounded-lg p-4">
                        <div class="flex">
                            ...
                            <div>
                                ...
                                <p class="mt-1 text-sm opacity-80">{{ __('profile.deletion_warning_description') }}
                                </p>
                            </div>
                        </div>
                    </div>
