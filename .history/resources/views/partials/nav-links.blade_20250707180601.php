...
<li>
    <button type="button"
            ...
            class="{{ $navLinkClasses }} flex items-center gap-1 align-middle"
            style="padding: 0 0.75rem; height: 100%;"
            aria-label="{{ __('assistant.open_butler_aria') }}">
        <span class="material-symbols-outlined align-middle" aria-hidden="true" style="font-size: 1.1em; vertical-align: middle;">support_agent</span>
