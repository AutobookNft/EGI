...
return [
    ...
    'form' => [
        ...
        'featured_image_hint' => 'Upload a representative image (JPEG, PNG, WebP, max 10MB). Used for previews and sharing.',
    ...
    'edit_page' => [
        ...
        'upload_images_help' => 'Upload images for your biography. Supported formats: JPG, PNG, WEBP (Max 10MB each)',
