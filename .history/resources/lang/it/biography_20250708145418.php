...
return [
    ...
    'manage' => [
        ...
        'subtitle' => 'Crea e gestisci le tue biografie personali',
        'your_biographies' => 'Le tue biografie',
        'description' => 'Gestisci le tue biografie personali e professionali',
        'create_new' => 'Crea nuova biografia',
        'create_first' => 'Crea la tua prima biografia',
        'empty_title' => 'Nessuna biografia ancora',
        'empty_description' => 'Inizia a creare la tua prima biografia per condividere la tua storia.',
    ...
    'form' => [
        ...
        'featured_image_hint' => 'Carica un\'immagine di copertina (jpeg, png, webp). Dimensione consigliata: 800x600px.',
    ],
];
