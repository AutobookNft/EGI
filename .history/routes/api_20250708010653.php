...
Route::middleware(['auth:sanctum'])->group(function () {
    ...
    // Biography Chapters
    Route::post('/biographies/{biographyId}/chapters', [App\Http\Controllers\Api\BiographyChapterController::class, 'store']);
    Route::put('/biographies/{biographyId}/chapters/{chapterId}', [App\Http\Controllers\Api\BiographyChapterController::class, 'update']);
    Route::delete('/biographies/{biographyId}/chapters/{chapterId}', [App\Http\Controllers\Api\BiographyChapterController::class, 'destroy']);
    Route::put('/biographies/{biographyId}/chapters/reorder', [App\Http\Controllers\Api\BiographyChapterController::class, 'reorder']);
