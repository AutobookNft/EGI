...
Route::post('/biography/chapters/{chapter}/media', [App\Http\Controllers\Api\BiographyChapterController::class, 'uploadMedia'])
    ->name('biography.chapters.media.upload')
    ->middleware('auth');
Route::delete('/biography/chapters/{chapter}/media', [App\Http\Controllers\Api\BiographyChapterController::class, 'removeMedia'])
