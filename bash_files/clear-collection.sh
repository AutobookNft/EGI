...
# Usage:
#   ./bash_files/clear-collection.sh [N] [--base PATH] [-n|--dry-run] [-y]
# Examples:
#   ./bash_files/clear-collection.sh 3
#   ./bash_files/clear-collection.sh --base /home/forge/default/storage/app/public/users_files
#   ./bash_files/clear-collection.sh 4 -n     # dry-run
#   ./bash_files/clear-collection.sh 2 -y     # no prompt
